constantsActive <- function(input,output,session, deployClick){
  ...
  dt <- reactive({
    ...
    sql <- "SELECT B.DNO 
            ...
            ON A.TRANSFORMER_NAME_FK = B.TRANSFORMER_NAME AND A.INDICATOR = 'Y'
            ORDER BY B.DNO, B.SUBSTATION_NAME, B.Transformer_DisplayName;"
